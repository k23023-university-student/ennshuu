...
public class HeroStudent extends Hero implements IHeroJob {

    public HeroStudent(String name, int hp, int atk, int def, int agi) {
...
//                + (new java.util.Random().nextInt(7) - 3); // ← −3〜+3のランダムな値
        ...
        //敵の残りHPの7割分に相当する攻撃を敵に与える
        int damage = (int)Math.ceil(target.getHp() * 0.7);
