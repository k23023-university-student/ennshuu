...
public class AichiToyotaAddress implements IKadai08_6{
    ...
    @Override public Map<String,String> searchByCode(String postalCode){
        Map<String, String> newMap = new HashMap<String, String>();
        POSTALCODE_MAP.forEach((k,v) ->{
            if(k.startsWith(postalCode)) newMap.put(k,v);
        });
        return newMap;
    }

    @Override public Map<String, String> searchByAddress(String addressText){
        Map<String, String> newMap = new HashMap<String, String>();
        POSTALCODE_MAP.forEach((k,v)->{
            if(v.contains(addressText)) newMap.put(k,v);
        });
        return newMap;
    }

    public static void main(String[] args){
        System.out.println(new AichiToyotaAddress().searchByCode("444"));
        System.out.println(new AichiToyotaAddress().searchByCode("471"));

        System.out.println(new AichiToyotaAddress().searchByCode("123"));
        System.out.println(new AichiToyotaAddress().searchByCode("3212"));

        System.out.println(new AichiToyotaAddress().searchByAddress("豊田市"));
        System.out.println(new AichiToyotaAddress().searchByAddress("町"));
        System.out.println(new AichiToyotaAddress().searchByAddress("桜町"));
        System.out.println(new AichiToyotaAddress().searchByAddress("豊橋"));
    }
}
